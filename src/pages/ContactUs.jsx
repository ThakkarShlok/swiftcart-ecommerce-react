...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!EMAILJS_SERVICE_ID || !EMAILJS_CONTACT_TEMPLATE_ID || !EMAILJS_PUBLIC_KEY) {
      console.warn('EmailJS env vars not set — check your .env file');
      return;
    }
  ...
  const contactMethods = [
    {
      ...
      title: 'Email Us',
      details: ['swiftcartsupport2026@gmail.com', 'careers@swiftcart.com'],
      action: 'mailto:swiftcartsupport2026@gmail.com',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Call Us',
      details: ['+91 81286 98935', 'Mon-Sat, 9AM - 6PM'],
      action: 'tel:+918128698935',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'WhatsApp Us',
      details: ['+91 81286 98935', 'Instant replies · Mon-Sat'],
      action: 'https://wa.me/918128698935?text=Hi%20SwiftCart!%20I%20need%20help.',
    },
  ];
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              ...
              {submitted === true && (
                <div className="mb-6 flex items-start gap-3 rounded-2xl border border-copper-100 bg-copper-50 p-4">
                  <span className="mt-0.5 shrink-0 text-base">✓</span>
                  <div>
                    <p className="text-sm font-semibold text-copper-700">Message sent!</p>
                    <p className="mt-0.5 text-xs text-copper-600">We'll get back to you within 24 hours.</p>
                  </div>
                </div>
              )}
              {submitted === 'error' && (
                <div className="mb-6 flex items-start gap-3 rounded-2xl border border-red-100 bg-red-50 p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-red-600">
                      ...
                      <a href="mailto:swiftcartsupport2026@gmail.com" className="underline font-medium">
                        swiftcartsupport2026@gmail.com
                      </a>
                    </p>
                  </div>
                </div>
