...
const Layout = ({ isLoggedIn, userData, handleLogout, searchQuery, setSearchQuery, showSearchInput, products }) => {
  ...
  return (
    <div className="min-h-screen bg-surface-100 text-ink-950">
          ...
          <div>
            ...
            <div className="mt-3 grid gap-2 text-sm text-ink-500">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 font-medium text-copper-600 hover:text-copper-700 transition-colors"
              >
      ...
      {/* WhatsApp support button — bottom left, opposite side from AI chatbot */}
      <a
        href="https://wa.me/918128698935?text=Hi%20SwiftCart!%20I%20need%20help%20with%20my%20order."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with SwiftCart support on WhatsApp"
        className="fixed bottom-5 left-5 z-50 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-sm transition hover:bg-[#1ebe5d] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30"
      >
